...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private SheikClient sheikClient;
    ...
    public void shutdownMinecraftApplet()
    {
        ...
        SheikClient.getInstance().onShutdown();
        System.gc();
    }
    ...
    private void runGameLoop() throws IOException
    {
        ...
        SheikClient.getInstance().onTick();
        this.mcProfiler.endSection();
    }
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                SheikClient.getInstance().getModuleManager().onKeyPress(k);
                if (Keyboard.getEventKeyState()) {
                    KeyBinding.onTick(k);
                    SheikClient.getInstance().getModuleManager().onKeyDown(k);
                }
