...
import net.minecraft.sheik.ui.hud.HudColors;
...
public class KeystrokesHUD extends Module implements HudPositionable {
	...
	private static final int BG_IDLE = HudColors.PANEL_BG;
	private static final int BG_PRESSED = HudColors.ACCENT;
	private static final int BORDER = HudColors.PANEL_BORDER;
	private static final int TEXT = HudColors.TEXT;
